...
export function MobileHorizontalNavbar() {
    return <div className='relative w-full flex flex-col items-center justify-center h-[5%]'>
        <nav className='w-5/6 h-full flex items-center justify-between z-100'>
            <div className="cascadia-code flex h-full w-full px-4 items-center justify-center bg-transparent">
                <NavbarButton
                    icon={faHome}
                    label="Home"
                    href="/"
